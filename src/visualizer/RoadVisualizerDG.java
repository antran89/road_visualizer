/*
 * Road Detector Visualizer and Offline Tester for DeepGlobe dataset
 * by an.tran@grab.com
 * 
 * Version history:
 * ================
...
public class RoadVisualizerDG implements ActionListener, ItemListener, MouseListener {
...
//		return parts[0] + "_" + parts[1] + "_" + parts[2];
	...
	public void setupGUI(int W) {
		...
		frame = new JFrame("Road Detector Visualizer for DeepGlobe dataset");
		int H = W * 2 / 3;
		frame.setSize(W, H);
    ...
    private void loadMap() {
		...
		String satImageId = currentImageId.replace("mask", "sat");
		f = new File(dir, satImageId + ".jpg");
		if (!f.exists()) {
	...
	public static void main(String[] args) throws Exception {
		...
		RoadVisualizerDG v = new RoadVisualizerDG();
		v.hasGui = true;
		int w = 1500;
